describe("List of Commands to test effectivly", () => {
  it("should invoke the browser and visit page", () => {
    ...
    cy.get(".products").find(".fruit").eq(2).contains("ADD TO CART").click(); // checks for the second (might click the 3rd) item on the search and gets  it add to card button
  });
});
